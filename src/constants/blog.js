import imgOne from "../assets/blog1.jpg";
import imgTwo from "../assets/blog2.jpg";
import imgThree from "../assets/blog3.jpg";
...
export const blogData = {
  ...
  ru: [
    {
      id: 1,
      name: "Топ 3 направления для посещения в Дубае на арендованной машине",
      text: "Одна из основных причин арендовать автомобиль в Дубае — это качество дорог в ОАЭ. Согласно Всемирному экономическому форуму, Эмираты входят в семерку стран с самым высоким качеством дорожной инфраструктуры.",
      date: "25 Сен 2022",
      imgUrl: imgOne,
      describtions: "Одна из основных причин арендовать автомобиль в Дубае — это качество дорог в ОАЭ. Согласно Всемирному экономическому форуму, Эмираты входят в семерку стран с самым высоким качеством дорожной инфраструктуры. Все дороги и шоссе регулярно обслуживаются и поддерживаются в отличном состоянии благодаря специальной государственной программе. Именно поэтому поездки из Дубая в отдаленные места кажутся такими захватывающими! И если вы любите новые впечатления и приключения, ваш отдых в Дубае будет неполным без посещения нескольких интересных районов ОАЭ.",
      city: "Абу-Даби",
      text2: "Если сочетание приключений и истории является вашей слабостью, то Хатта никогда не должна быть исключена из вашего списка первоочередных направлений. Поездка, которая займет всего пару часов, приведет вас в горный район с заметно более прохладным климатом. Благодаря своему высокогорному расположению среди красивых гор Хаджар, ощущение простора и освобождения, которое вы почувствуете после удушающей жары Дубая, — это то, что вам действительно нужно для перемен и свежих впечатлений. Эта поездка расширит ваш опыт в Эмиратах, так как позволит вам исследовать совершенно другую область с замечательными особенностями..."
    },
    {
      id: 2,
      name: "Топ 5 прекрасных мест для фотосессий с автомобилем в Дубае",
      text: "В Дубае есть много замечательных занятий, но когда вы арендуете автомобиль, ваши возможности практически удваиваются. Количество мест, куда вы захотите поехать и сделать памятные фотографии, настолько велико, что вам будет трудно удержаться от аренды транспортного средства хотя бы на день или два, если не на пару часов.",
      date: "11 Фев 2022",
      imgUrl: imgTwo,
      describtions: "В Дубае есть много замечательных занятий, но когда вы арендуете автомобиль, ваши возможности практически удваиваются. Количество мест, куда вы захотите поехать и сделать памятные фотографии, настолько велико, что вам будет трудно удержаться от аренды транспортного средства хотя бы на день или два, если не на пару часов. Но как сделать впечатляющие фотографии на фоне автомобиля и Дубая, которые оставят приятные воспоминания и впечатлят ваших друзей? Часто бывает, что когда вы находите отличное место для фотографии, вы сталкиваетесь с препятствиями...",
      city: "Пальма Джумейра",
      text2: "Пальма Джумейра — это рукотворный архипелаг, созданный с помощью намыва земли. Спроектированный так, чтобы напоминать ветвистую пальму, он является известным примером современного градостроительства и архитектурного мастерства. Неудивительно, что Пальма Джумейра привлекает множество людей..."
    },
    {
      id: 3,
      name: "Топ 5 причин арендовать автомобиль в стиле Дубая этим летом",
      text: "Лето — это не только пляж и тело, а Autozoom Luxury Car Rental — это не просто обычный бизнес по аренде автомобилей. Мы — ваш универсальный четырёхколёсный спутник для максимального удовольствия от времени, проведённого в Дубае.",
      date: "31 Июл 2022",
      imgUrl: imgThree,
      city: "Бурдж Халифа",
      describtions: "Получите максимум от вашего отпуска или деловой поездки в Дубай, посещая множество мест каждый раз на разных автомобилях! Лето — это не только пляж и тело, а Autozoom Luxury Car Rental — это не просто обычный бизнес по аренде автомобилей. Мы — ваш универсальный четырёхколёсный спутник для максимального удовольствия...",
      text2: "Позднее лето и ранняя осень — наше обычное время лучших предложений и акций. Мы приготовили приятный сюрприз для всех, кто обожает приключения и вождение! В эти дни вы можете получить одно из лучших предложений по аренде автомобилей в городе..."
    }
  ]
}
